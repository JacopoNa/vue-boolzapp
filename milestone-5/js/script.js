...
var app = new Vue(
	{
		...
		methods: {
			...
			showBox(index) {
				this.contacts[this.currentContact].messages[index].showAction = !this.contacts[this.currentContact].messages[index].showAction 	
			},
			deleteMessage(index) {
				this.contacts[this.currentContact].messages[index].text = `QUESTO MESSAGGIO E' STATO ELIMINATO`;
				this.contacts[this.currentContact].messages[index].showAction = false;
			}
